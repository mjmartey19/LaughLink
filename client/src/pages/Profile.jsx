...
import { apiRequest, deletePost, fetchPosts, getUserInfo, likePost } from "../utils";
...
const Profile = () => {
  ...
  const uri = "/posts/get-user-post/" + id; //Fetch post of a particular user
